...
| 2026-05-29 | main | feat | feat(路由): 完成Day1路由骨架与基础页面接入 | 路由驱动渲染、布局路由化、基础页面闭环 | lint/build 通过 |
| 2026-05-29 | main | docs | docs(任务): 更新Day1验收结果与主线状态 | Day1 看板与验收结果同步 | 文档检查通过 |
...
## 9. 文档协作约定
- 默认由 AI 助手维护项目文档，用户审核确认。
- 除非用户明确要求，不再让用户手工更新文档。
